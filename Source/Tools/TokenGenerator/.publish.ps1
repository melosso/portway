...
# Publish framework-dependent with size optimizations and preserve JSON functionality
Write-Host "Publishing optimized framework-dependent version..." -ForegroundColor Cyan
dotnet publish $toolsDir -c Release -r win-x64 --self-contained false -p:PublishSingleFile=true `
