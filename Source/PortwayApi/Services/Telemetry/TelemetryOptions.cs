...
public sealed record TelemetryOptions
{
    ...
    /// <summary>
    /// Legacy flat switch; true selects the Otlp provider when Provider is unset
    /// </summary>
    public bool Enabled { get; init; } = false;
    /// <summary>
    /// Legacy flat endpoint; used when Otlp:Endpoint is not configured
    /// </summary>
    ...
    /// <summary>
    /// Scrape path when the Prometheus provider is active, otherwise null
    /// </summary>
