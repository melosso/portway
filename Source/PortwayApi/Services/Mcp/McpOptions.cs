...
public sealed record McpOptions
{
    ...
    /// <summary>
    /// Rows appended as $top when the LLM omits it; prevents unbounded table scans
    /// </summary>
    public int    DefaultPageSize        { get; init; } = 50;
    /// <summary>
    /// Maximum $top value allowed; clamped if the LLM requests more
    /// </summary>
    public int    MaxPageSize            { get; init; } = 200;
    /// <summary>
    /// Timeout in seconds for internal tool-execution HTTP calls; default 30
    /// </summary>
