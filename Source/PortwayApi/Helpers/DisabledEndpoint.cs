...
/// <summary>
/// The single response for an endpoint switched off through its Enabled flag
/// </summary>
public static class DisabledEndpoint
{
    ...
    /// <summary>
    /// 503 for controller-served endpoints
    /// </summary>
    ...
    /// <summary>
    /// 503 for handlers that return minimal-API results
    /// </summary>
