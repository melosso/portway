...
public class UrlValidator
{
    ...
    /// <summary>
    /// Returns true if the given remote IP is loopback or matches one of the allowed hosts. Used to restrict the administration UI to the local network
    /// </summary>
    ...
    /// <summary>
    /// Matches host against a wildcard pattern
    /// </summary>
    ...
    /// <summary>
    /// Checks whether the IP falls outside all blocked ranges
    /// </summary>
