...
{
    /// <summary>
    /// 503 with a Retry-After hint; needs the controller to reach the response headers
    /// </summary>
    ...
    /// <summary>
    /// Masked 500 in the shared envelope for handlers that return minimal-API results
    /// </summary>
    ...
    /// <summary>
    /// Trace id a caller can quote when reporting a masked error
    /// </summary>
    ...
    /// <summary>
    /// 503 without a Retry-After; use the ControllerBase overload or set the header yourself when a hint is needed
    /// </summary>
    ...
    /// <summary>
    /// Tells clients and caches how long to back off before retrying a deliberate outage
    /// </summary>
