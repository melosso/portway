...
{
    /// <summary>Interface for cache providers used by the application</summary>
    public interface ICacheProvider
    {
        ...
        /// <summary>Gets connection status for the cache provider</summary>
    ...
    /// <summary>Represents a distributed lock handle that can be disposed to release the lock</summary>
    public interface ILockHandle : IDisposable
    {
        /// <summary>The key being locked</summary>
        string Key { get; }
        ...
        /// <summary>Extends the lock's expiration time</summary>
        ...
        /// <summary>Releases the lock explicitly (also happens on Dispose)</summary>
        /// <returns>Task representing the asynchronous operation</returns>
        Task ReleaseAsync();
    }
}