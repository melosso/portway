...
/// <summary>
/// Verbs Portway serves that HttpMethod has no static for; cached because HttpMethod.Parse allocates for unknown verbs
/// </summary>
public static class OpenApiHttpMethods
{
    /// <summary>
    /// OData-style partial update; OpenAPI 3.2 emits it under a path item's additionalOperations
    /// </summary>
