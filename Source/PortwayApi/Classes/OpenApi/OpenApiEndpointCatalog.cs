...
/// <summary>
/// Maps every configured endpoint to the OpenAPI path template its operations live under
/// </summary>
internal static class OpenApiEndpointCatalog
{
    ...
    /// <summary>
    /// Environments an endpoint is documented for: its own allowlist when set, else the global one
    /// </summary>
    ...
    /// <summary>
    /// Matches a base and its id and sub-path variants, without matching a longer sibling name
    /// </summary>
