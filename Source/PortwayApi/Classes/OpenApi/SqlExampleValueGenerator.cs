...
/// <summary>
/// Generates example JSON values for OpenAPI documentation based on SQL column/parameter metadata. Extracted from SqlMetadataDocumentFilter to enable unit testing
/// </summary>
public static class SqlExampleValueGenerator
{
    /// <summary>
    /// Generates an example value based on column metadata. Returns null for nullable columns
    /// </summary>
