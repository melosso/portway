...
public class AuthenticationSettings
{
    ...
    /// <summary>
    /// If true, ONLY custom authentication is allowed. Global tokens are ignored for this environment. If false (default), global tokens can still be used if custom auth fails
    /// </summary>
